...
class _DetailPembelianPageState extends State<DetailPembelianPage> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (!_isLoading && _filteredData.isNotEmpty) ...[
                      _buildTotalHargaBox(),
                      const SizedBox(height: 24),
                      _buildPagination(_filteredData.length, (_filteredData.length / _itemsPerPage).ceil()),
                    ],
                  ],
                ),
              ),
  ...
  Widget _buildResponsiveTable(List<Map<String, dynamic>> data) {
    ...
    final List<Map<String, dynamic>> dataOnCurrentPage = data.sublist(startIndex, endIndex);

    if (dataOnCurrentPage.isEmpty) {
      ...
      child: SingleChildScrollView(
        ...
        child: Container(
          ...
          child: Theme(
            ...
            child: _buildDataTable(dataOnCurrentPage),
          ),
        ),
      ),
    );
